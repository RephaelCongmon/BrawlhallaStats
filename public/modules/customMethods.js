function showStats(result) {
    ...
    if ((result.error) && (result.error.code == 404) ){
        ...
        var legendTime;
        var str = "";
        str += `<table id="leaderboard-table" class="table table-striped table-bordered dt-responsive dataTable no-footer dtr-inline" role="grid" aria-describedby="leaderboard-table-info" width="100%" class="display nowrap">
        <tbody>`;
